...
Para gerar sua API_KEY, basta fazer um GET na rota [caesarv2.herokuapp.com/register](caesarv2.herokuapp.com/register) usando seu e-mail como parâmetro:
```
...
Para fazer login no sistema, basta fazer um POST na rota [caesarv2.herokuapp.com/login](caesarv2.herokuapp.com/register) usando seu email e chave de API como parâmetros:
```
POST /login HTTP/1.1
Host: api.0x1.pw
